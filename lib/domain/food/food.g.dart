...
void _foodSerialize(
  ...
  writer.writeDouble(offsets[0], object.fat);
...
Food _foodDeserialize(
  ...
  final object = Food();
  object.fat = reader.readDoubleOrNull(offsets[0]);
  object.id = id;
  object.kcal = reader.readDoubleOrNull(offsets[1]);
...
extension FoodQueryFilter on QueryBuilder<Food, Food, QFilterCondition> {
  ...
  QueryBuilder<Food, Food, QAfterFilterCondition> kcalIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'kcal',
      ));
  ...
  QueryBuilder<Food, Food, QAfterFilterCondition> kcalIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'kcal',
      ));
